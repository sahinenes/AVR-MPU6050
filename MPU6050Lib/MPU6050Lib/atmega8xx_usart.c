...
void usartInit(USART_t* pUSART)
{
	...
	baud = (pUSART->clockSpeed/(pUSART->USARTbaudRate*speed)) - 1;
	...
	UCSRC|=(1<<URSEL)|(pUSART->USARTsettings.operation<<UMSEL)|(pUSART->USARTsettings.parityMode<<UPM0)|(pUSART->USARTsettings.stop<<USBS)|(pUSART->USARTsettings.clockPolarity<<UCPOL)|(1<<UCSZ0)|(1<<UCSZ1);
